...
IFG:: Impaired fasting glucose, häiriintynyt paastoglukoosi: Verensokeri pysyy jatkuvasti koholla (osaltaan insuliiniresistenssin takia)
IGT:: Impaired glucose tolerance, heikentynyt glukoosinsieto. Näkyy glukoosirasitustestissä (2h jälkeen verensokeri edelleen koholla)
